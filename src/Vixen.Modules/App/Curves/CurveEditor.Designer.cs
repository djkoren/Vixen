...
namespace VixenModules.App.Curves
{
	partial class CurveEditor
	{
		...
		private void InitializeComponent()
		{
			...
			this.txtYValue.MaxValue = 100D;
			this.txtYValue.MinCheck = true;
			this.txtYValue.MinValue = 0D;
			this.txtYValue.Name = "txtYValue";
			this.txtYValue.NumberFormat = NumberFormat.DecimalValue;
			...
			this.txtXValue.MaxValue = 100D;
			this.txtXValue.MinCheck = true;
			this.txtXValue.MinValue = 0D;
			this.txtXValue.Name = "txtXValue";
			this.txtXValue.NumberFormat = NumberFormat.DecimalValue;
